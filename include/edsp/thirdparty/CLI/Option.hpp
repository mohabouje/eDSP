...
#include "edsp/thirdparty/CLI/Validators.hpp"
...
namespace CLI {
    ...
    protected:
        ...
        Option(std::string name, std::string description, std::function<bool(results_t)> callback, bool defaulted,
               App* parent) :
    ...
    public:
        ...
        Option* set_type_name(std::string typeval) {
