...
#    define any_USES_STD_ANY \
        ((any_CONFIG_SELECT_ANY == any_ANY_STD) || ((any_CONFIG_SELECT_ANY == any_ANY_DEFAULT) && any_HAVE_STD_ANY))
...
#        endif
        ...
        public:
            ...
            any(any const& other) : content(other.content ? other.content->clone() : any_nullptr) {}
...
#        if any_CPP11_OR_GREATER
            ...
            any(ValueType&& value) any_noexcept : content(new holder<T>(std::move(value))) {}
...
#        endif // any_CPP11_OR_GREATER
        ...
        any_nodiscard inline ValueType const* any_cast(any const* operand) any_noexcept {
            return operand != any_nullptr && operand->type() == typeid(ValueType) ? operand->to_ptr<ValueType>()
                                                                                  : any_nullptr;
        }
