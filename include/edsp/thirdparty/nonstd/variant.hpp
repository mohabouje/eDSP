...
#        if variant_CPP11_OR_GREATER || variant_COMPILER_MSVC_VERSION >= 14 || \
            (variant_COMPILER_MSVC_VERSION >= 9 && _HAS_CPP0X)
...
#            define variant_REQUIRES_T(...) , typename = typename std::enable_if<__VA_ARGS__>::type

#            define variant_REQUIRES_R(R, ...) typename std::enable_if<__VA_ARGS__, R>::type

#            define variant_REQUIRES_A(...) , typename std::enable_if<__VA_ARGS__, void*>::type = variant_nullptr
...
#            define variant_ALIGN_AS(to_align) \
            ...
            struct alignment_of {
                enum {
                    value = alignment_logic<sizeof(alignment_of_hack<T>) - sizeof(T), sizeof(T)>::value,
                };
            };

            template <typename List, size_t N>
            struct type_of_size {
                typedef typename conditional<N == sizeof(typename List::head), typename List::head,
...
#        if variant_CPP11_OR_GREATER
                ...
                static type_index_t move(std::size_t const from_index, void* from_value, void* to_value) {
                    switch (from_index) {
                        case 0:
                            new (to_value) T0(std::forward<T0>(*as<T0>(from_value)));
                            break;
                        case 1:
                            new (to_value) T1(std::forward<T1>(*as<T1>(from_value)));
                            break;
                        case 2:
                            new (to_value) T2(std::forward<T2>(*as<T2>(from_value)));
                            break;
                        case 3:
                            new (to_value) T3(std::forward<T3>(*as<T3>(from_value)));
                            break;
                        case 4:
                            new (to_value) T4(std::forward<T4>(*as<T4>(from_value)));
                            break;
                        case 5:
                            new (to_value) T5(std::forward<T5>(*as<T5>(from_value)));
                            break;
                        case 6:
                            new (to_value) T6(std::forward<T6>(*as<T6>(from_value)));
                            break;
                        case 7:
                            new (to_value) T7(std::forward<T7>(*as<T7>(from_value)));
                            break;
                        case 8:
                            new (to_value) T8(std::forward<T8>(*as<T8>(from_value)));
                            break;
                        case 9:
                            new (to_value) T9(std::forward<T9>(*as<T9>(from_value)));
                            break;
                        case 10:
                            new (to_value) T10(std::forward<T10>(*as<T10>(from_value)));
                            break;
                        case 11:
                            new (to_value) T11(std::forward<T11>(*as<T11>(from_value)));
                            break;
                        case 12:
                            new (to_value) T12(std::forward<T12>(*as<T12>(from_value)));
                            break;
                        case 13:
                            new (to_value) T13(std::forward<T13>(*as<T13>(from_value)));
                            break;
                        case 14:
                            new (to_value) T14(std::forward<T14>(*as<T14>(from_value)));
                            break;
                        case 15:
                            new (to_value) T15(std::forward<T15>(*as<T15>(from_value)));
                            break;
                    }
                        ...
                        std::is_nothrow_move_constructible<T4>::value&& std::is_nothrow_move_constructible<T5>::value&&
                            std::is_nothrow_move_constructible<T6>::value&& std::is_nothrow_move_constructible<
                                ...
                                std::is_nothrow_move_constructible<T9>::value&& std::is_nothrow_move_constructible<
                                    ...
                                    std::is_nothrow_move_constructible<T12>::value&& std::is_nothrow_move_constructible<
                                        T13>::value&& std::is_nothrow_move_constructible<T14>::value&&
...
#        else
            variant& operator=(T0 const& t0) {
                return copy_assign_value<T0, 0>(t0);
            }
            variant& operator=(T1 const& t1) {
                return copy_assign_value<T1, 1>(t1);
            }
            variant& operator=(T2 const& t2) {
                return copy_assign_value<T2, 2>(t2);
            }
            variant& operator=(T3 const& t3) {
                return copy_assign_value<T3, 3>(t3);
            }
            variant& operator=(T4 const& t4) {
                return copy_assign_value<T4, 4>(t4);
            }
            variant& operator=(T5 const& t5) {
                return copy_assign_value<T5, 5>(t5);
            }
            variant& operator=(T6 const& t6) {
                return copy_assign_value<T6, 6>(t6);
            }
            variant& operator=(T7 const& t7) {
                return copy_assign_value<T7, 7>(t7);
            }
            variant& operator=(T8 const& t8) {
                return copy_assign_value<T8, 8>(t8);
            }
            variant& operator=(T9 const& t9) {
                return copy_assign_value<T9, 9>(t9);
            }
            variant& operator=(T10 const& t10) {
                return copy_assign_value<T10, 10>(t10);
            }
            variant& operator=(T11 const& t11) {
                return copy_assign_value<T11, 11>(t11);
            }
            variant& operator=(T12 const& t12) {
                return copy_assign_value<T12, 12>(t12);
            }
            variant& operator=(T13 const& t13) {
                return copy_assign_value<T13, 13>(t13);
            }
            variant& operator=(T14 const& t14) {
                return copy_assign_value<T14, 14>(t14);
            }
            variant& operator=(T15 const& t15) {
                return copy_assign_value<T15, 15>(t15);
            }
...
#        endif // variant_CONFIG_MAX_ALIGN_HACK
        ...
        template <std::size_t K, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7,
                  class T8, class T9, class T10, class T11, class T12, class T13, class T14, class T15>
        inline typename detail::add_pointer<typename variant_alternative<
        ...
        template <std::size_t K, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7,
                  class T8, class T9, class T10, class T11, class T12, class T13, class T14, class T15>
        inline typename detail::add_pointer<const typename variant_alternative<
            K, variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>>::type>::type
            get_if(variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15> const* pv,
                   nonstd_lite_in_place_index_t(K) = nonstd_lite_in_place_index(K)) {
            return (pv->index() == K) ? &get<K>(*pv) : variant_nullptr;
        ...
        template <class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9,
                  class T10, class T11, class T12, class T13, class T14, class T15>
        inline void
            swap(variant<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15>& a,
