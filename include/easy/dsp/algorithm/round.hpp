 ...
 * Date: 3/8/2018
 */
#ifndef EASYDSP_ALGORITHM_ROUND_HPP
#define EASYDSP_ALGORITHM_ROUND_HPP
...
namespace easy { namespace dsp { inline namespace algorithm {
    ...
    constexpr void round(InputIt first, InputIt last, OutputIt d_first) {
        std::transform(
            first, last, d_first,
            [](const meta::value_type_t<InputIt> value) -> meta::value_type_t<OutputIt> { return std::round(value); });
    }

}}} // namespace easy::dsp::algorithm

#endif // EASYDSP_ALGORITHM_ROUND_HPP
