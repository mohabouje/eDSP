...
#include <easy/dsp/spectral/types.hpp>

#include <complex>
#include <fftw3.h>
#include <algorithm>

namespace easy { namespace dsp { inline namespace spectral { inline namespace internal {
    template <typename T>
...
}}}} // namespace easy::dsp::spectral::internal
