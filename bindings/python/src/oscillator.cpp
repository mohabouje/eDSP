...
void add_oscillator_package() {
    ...
    bp::class_<base_class>
            ("Oscillator", bp::init<real_t, real_t, real_t, real_t>((bp::arg("amp"), bp::arg("sr"), bp::arg("f"), bp::arg("p")), ""))
    ...
    bp::class_<edsp::oscillators::sin_oscillator<real_t>, bp::bases<base_class>>
            ("Sinusoidal", bp::init<real_t, real_t, real_t, real_t>((bp::arg("amp"), bp::arg("sr"), bp::arg("f"), bp::arg("p")), ""))
    ...
    bp::class_<edsp::oscillators::square_oscillator<real_t>, bp::bases<base_class>>
            ("Square", bp::init<real_t, real_t, real_t, real_t>((bp::arg("amp"), bp::arg("sr"), bp::arg("f"), bp::arg("duty")), ""))
    ...
    bp::class_<edsp::oscillators::sawtooth_oscillator<real_t>, bp::bases<base_class>>
            ("Sawtooth", bp::init<real_t, real_t, real_t, real_t>((bp::arg("amp"), bp::arg("sr"), bp::arg("f"), bp::arg("width")), ""))
