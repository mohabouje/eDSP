...
**easy DSP** is an digital signal processing library written in C/C++ that implements some of the common functions and algorithms for signal processing & telecommunications systems. 
