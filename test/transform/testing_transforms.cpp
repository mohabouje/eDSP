...
static constexpr std::array<std::complex<float>, 64> hamming_fft = {
    {{34.1000f, 0.0000f}, {-14.8121f, -0.7277f}, {0.1589f, 0.0157f},  {0.0587f, 0.0087f},  {0.0309f, 0.0061f},  {0.0190f, 0.0048f},
     {0.0128f, 0.0039f},  {0.0091f, 0.0033f},    {0.0068f, 0.0028f},  {0.0052f, 0.0024f},  {0.0040f, 0.0022f},  {0.0032f, 0.0019f},
     {0.0026f, 0.0017f},  {0.0021f, 0.0016f},    {0.0017f, 0.0014f},  {0.0014f, 0.0013f},  {0.0011f, 0.0011f},  {0.0009f, 0.0010f},
     {0.0008f, 0.0009f},  {0.0006f, 0.0009f},    {0.0005f, 0.0008f},  {0.0004f, 0.0007f},  {0.0003f, 0.0006f},  {0.0003f, 0.0005f},
     {0.0002f, 0.0005f},  {0.0001f, 0.0004f},    {0.0001f, 0.0003f},  {0.0001f, 0.0003f},  {0.0000f, 0.0002f},  {0.0000f, 0.0002f},
     {0.0000f, 0.0001f},  {0.0000f, 0.0001f},    {0.0000f, 0.0000f},  {0.0000f, -0.0001f}, {0.0000f, -0.0001f}, {0.0000f, -0.0002f},
     {0.0000f, -0.0002f}, {0.0001f, -0.0003f},   {0.0001f, -0.0003f}, {0.0001f, -0.0004f}, {0.0002f, -0.0005f}, {0.0003f, -0.0005f},
     {0.0003f, -0.0006f}, {0.0004f, -0.0007f},   {0.0005f, -0.0008f}, {0.0006f, -0.0009f}, {0.0008f, -0.0009f}, {0.0009f, -0.0010f},
     {0.0011f, -0.0011f}, {0.0014f, -0.0013f},   {0.0017f, -0.0014f}, {0.0021f, -0.0016f}, {0.0026f, -0.0017f}, {0.0032f, -0.0019f},
     {0.0040f, -0.0022f}, {0.0052f, -0.0024f},   {0.0068f, -0.0028f}, {0.0091f, -0.0033f}, {0.0128f, -0.0039f}, {0.0190f, -0.0048f},
