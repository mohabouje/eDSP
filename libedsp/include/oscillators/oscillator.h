...
EDSP_BEGIN_NAMESPACE
    ...
    public:
        ...
        Oscillator(value_type amplitude_, value_type samplerate_, value_type frequency_, value_type phase_);
        /**
    ...
    Oscillator::Oscillator(Oscillator::value_type amplitude_, Oscillator::value_type samplerate_,
                           Oscillator::value_type frequency_, Oscillator::value_type phase_) : amplitude_(amplitude_),
    ...
    void Oscillator::set_timestamp(Oscillator::value_type timestamp) EDSP_NOEXCEPT {
    ...
    void Oscillator::set_samplerate(Oscillator::value_type samplerate) EDSP_NOEXCEPT {
    ...
    void Oscillator::set_frequency(Oscillator::value_type frequency) EDSP_NOEXCEPT {
    ...
    void Oscillator::set_phase(Oscillator::value_type phase) EDSP_NOEXCEPT {
        phase_ = phase;
    }
    ...
    void Oscillator::set_amplitude(Oscillator::value_type amplitude) EDSP_NOEXCEPT {
